...
<head>
	...
	<link rel="shortcut icon" href="assets/images/sin-ttulo-1-276x235.png" type="image/x-icon">
			...
			<div class="navbar-brand">
                <span class="navbar-logo">
                    <a href="<?PHP echo base_url(); ?>">
                        <img src="<?PHP echo base_url('assets/images/sin-ttulo-1-276x235.png'); ?>" alt="Novapiel" title=""
														 style="height: 4.7rem;">
                    </a>
                </span>
			...
			<ul class="navbar-nav nav-dropdown" data-app-modern-menu="true">
				...
				<li class="nav-item dropdown">
					...
					<div class="dropdown-menu"><a class="text-black dropdown-item display-4" href="<?PHP echo base_url('servicios/botox'); ?>"
							...
							class="text-black dropdown-item display-4" href="<?PHP echo base_url('servicios/peeling_facial'); ?>"
							aria-expanded="false">PEELING FACIAL</a><a class="text-black dropdown-item display-4"
																												 href="<?PHP echo base_url('servicios/prp'); ?>" aria-expanded="false">PLASMA
							RICO EN PLAQUETAS</a><a class="text-black dropdown-item display-4"
																			href="<?PHP echo base_url(); ?>" aria-expanded="false">HILOS
							REVITALIZANTES</a><a class="text-black dropdown-item display-4" href="<?PHP echo base_url('servicios/mesoterapia_facial'); ?>"
																	 aria-expanded="false">MESOTERAPIA FACIAL</a></div>
				</li>
				<li class="nav-item"><a class="nav-link link text-black display-4" href="<?PHP echo base_url('ubicacion'); ?>"><span
		...
		<div class="media-container-row content mbr-white">
			...
			<div class="col-12 col-md-3 mbr-fonts-style display-7">
				<p class="mbr-text">
					...
					<br>
					<br>Si te gustó la experiencia dejanos tus comentarios&nbsp;<br>AQUI.</p>
			</div>
